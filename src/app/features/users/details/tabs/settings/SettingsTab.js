                    ...
                    <form id="kt_account_profile_details_form" className="form">
                        ...
                        <div className="card-body border-top p-9">
                            ...
                            <div className="row mb-6">
                                ...
                                {/*begin::Col*/}
                                <div className="col-lg-8 fv-row">
                                    <select name="country" aria-label="Select a Country" data-control="select2" data-placeholder="Select a country..." className="form-select form-select-solid form-select-lg fw-bold">
                            ...
                            <div className="row mb-6">
                                ...
                                {/*begin::Col*/}
                                <div className="col-lg-8 fv-row">
                                    <select name="currnecy" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select a currency.." className="form-select form-select-solid form-select-lg">
                                    ...
                                    <div className="row mb-6">
                                        <div className="col-lg-6 mb-4 mb-lg-0">
                                            <div className="fv-row mb-0">
                                                <label htmlFor="emailaddress" className="form-label fs-6 fw-bolder mb-3">Enter New Email Address</label>
                                        ...
                                        <div className="col-lg-6">
                                            <div className="fv-row mb-0">
                                                <label htmlFor="confirmemailpassword" className="form-label fs-6 fw-bolder mb-3">Confirm Password</label>
                            ...
                            <div className="d-flex flex-stack flex-grow-1">
                                ...
                                <div className="fw-bold">
                                    <div className="fs-6 text-gray-700">Two-factor authentication adds an extra layer of security to your account. To log in, in you'll need to provide a 4 digit amazing code.
                                        <a href="#" className="fw-bolder">Learn More</a></div>
                                </div>
                                {/*end::Content*/}
                            </div>
                            {/*end::Wrapper*/}
                    ...
                    <form id="kt_account_deactivate_form" className="form">
                        ...
                        <div className="card-body border-top p-9">
                                ...
                                <div className="d-flex flex-stack flex-grow-1">
                                    ...
                                    <div className="fw-bold">
                                        ...
                                        <div className="fs-6 text-gray-700">For extra security, this requires you to confirm your email or phone number when you reset yousignr password.
                                            <br />
                                            <a className="fw-bolder" href="#">Learn more</a></div>
                                    </div>
                                    {/*end::Content*/}
                                </div>
                                {/*end::Wrapper*/}
                            ...
                            <div className="form-check form-check-solid fv-row">
                                ...
                                <label className="form-check-label fw-bold ps-2 fs-6" htmlFor="deactivate">I confirm my account deactivation</label>
                            </div>
                            {/*end::Form input row*/}
                        </div>
                        {/*end::Card body*/}
                        {/*begin::Card footer*/}
                        <div className="card-footer d-flex justify-content-end py-6 px-9">
                            <button id="kt_account_deactivate_account_submit" type="submit" className="btn btn-danger fw-bold">Deactivate Account</button>
                        </div>
                        {/*end::Card footer*/}
                    </form>
                    {/*end::Form*/}
