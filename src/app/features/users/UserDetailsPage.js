                        ...
                        <div className="d-flex flex-column flex-lg-row">
                                ...
                                <div className="card mb-5 mb-xl-8">
                                    <div className="card-body">
                                        <div className="d-flex flex-center flex-column py-5">
                                            ...
                                            <div className="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3" style={{cursor: "default"}}>{ user.firstName + " " + user.lastName }</div>
                                            <div className="mb-9">
                                        ...
                                        <div id="kt_user_view_details" className="collapse show">
                                            <div className="pb-5 fs-6">
                                                ...
                                                <div className="text-gray-600">
                                                    <a href="#" className="text-gray-600 text-hover-primary">{user.email}</a>
                                                </div>
                                                <div className="fw-bolder mt-5">Car</div>
                                                
                                                {user.car 
                                                    ? <Link to={ `/cars/${user.car.id}` } className="text-gray-800 text-hover-primary mb-1">
                                                        {user.car.brand + " " + user.car.model}
                                                    </Link>
                                                    : <div className="text-gray-600">None</div>}
                                                <div className="fw-bolder mt-5">Phone Number</div>
                                                <div className="text-gray-600">{user.phoneNumber ? user.phoneNumber : "-"}</div>
                            ...
                            <div className="card mb-5 mb-xl-8">
                                ...
                                <div className="py-2">
                                    ...
                                    <div className="d-flex justify-content-end">
                                        ...
                                        {/*end::Input*/}
                                        {/*begin::Label*/}
                                        <span className="form-check-label fw-bold text-muted" htmlFor="kt_modal_connected_accounts_github" />
                                        {/*end::Label*/}
                                        </label>
                                        {/*end::Switch*/}
                                    </div>
                                    ...
                                    <div className="d-flex justify-content-end">
                                        ...
                                        {/*end::Input*/}
                                        {/*begin::Label*/}
                                        <span className="form-check-label fw-bold text-muted" htmlFor="kt_modal_connected_accounts_slack" />
                                        {/*end::Label*/}
                                        </label>
                                        {/*end::Switch*/}
                                    </div>
                            ...
                            <div className="tab-content" id="myTabContent">
                                ...
                                <div className="card pt-4 mb-6 mb-xl-9">
                                    ...
                                    <div className="card-toolbar">
                                        {/*begin::Add*/}
                                        <button type="button" className="btn btn-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                ...
                                <div className="card pt-4 mb-6 mb-xl-9">
                                    ...
                                    <form className="form" id="kt_users_email_notification_form">
                                        ...
                                        <div className="form-check form-check-custom form-check-solid">
                                            {/*begin::Input*/}
                                            <input className="form-check-input me-3" name="email_notification_0" type="checkbox" defaultValue={0} id="kt_modal_update_email_notification_0" defaultChecked="checked" />
                                            {/*end::Input*/}
                                            {/*begin::Label*/}
                                        ...
                                        <div className="form-check form-check-custom form-check-solid">
                                            {/*begin::Input*/}
                                            <input className="form-check-input me-3" name="email_notification_1" type="checkbox" defaultValue={1} id="kt_modal_update_email_notification_1" />
                                            {/*end::Input*/}
                                            {/*begin::Label*/}
                                        ...
                                        <div className="form-check form-check-custom form-check-solid">
                                            {/*begin::Input*/}
                                            <input className="form-check-input me-3" name="email_notification_2" type="checkbox" defaultValue={2} id="kt_modal_update_email_notification_2" />
                                            {/*end::Input*/}
                                            {/*begin::Label*/}
                                        ...
                                        <div className="form-check form-check-custom form-check-solid">
                                            {/*begin::Input*/}
                                            <input className="form-check-input me-3" name="email_notification_3" type="checkbox" defaultValue={3} id="kt_modal_update_email_notification_3" defaultChecked="checked" />
                                            {/*end::Input*/}
                                            {/*begin::Label*/}
                                        ...
                                        <div className="form-check form-check-custom form-check-solid">
                                            {/*begin::Input*/}
                                            <input className="form-check-input me-3" name="email_notification_4" type="checkbox" defaultValue={4} id="kt_modal_update_email_notification_4" defaultChecked="checked" />
                                            {/*end::Input*/}
                                            {/*begin::Label*/}
                                        ...
                                        <div className="form-check form-check-custom form-check-solid">
                                            {/*begin::Input*/}
                                            <input className="form-check-input me-3" name="email_notification_5" type="checkbox" defaultValue={5} id="kt_modal_update_email_notification_5" />
                                            {/*end::Input*/}
                                            {/*begin::Label*/}
                                        ...
                                        <div className="form-check form-check-custom form-check-solid">
                                            {/*begin::Input*/}
                                            <input className="form-check-input me-3" name="email_notification_6" type="checkbox" defaultValue={6} id="kt_modal_update_email_notification_6" />
                                            {/*end::Input*/}
                                            {/*begin::Label*/}
                                        ...
                                        <div className="form-check form-check-custom form-check-solid">
                                            {/*begin::Input*/}
                                            <input className="form-check-input me-3" name="email_notification_7" type="checkbox" defaultValue={7} id="kt_modal_update_email_notification_7" />
                                            {/*end::Input*/}
                                            {/*begin::Label*/}
                                        ...
                                        <div className="form-check form-check-custom form-check-solid">
                                            {/*begin::Input*/}
                                            <input className="form-check-input me-3" name="email_notification_8" type="checkbox" defaultValue={8} id="kt_modal_update_email_notification_8" />
                                            {/*end::Input*/}
                                            {/*begin::Label*/}
                                ...
                                <div className="card pt-4 mb-6 mb-xl-9">
                                    ...
                                    <div className="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            {/*end::Badge=*/}
                                            {/*begin::Status=*/}
                                            <td>POST /v1/invoice/in_7171_7171/invalid</td>
                                            {/*end::Status=*/}
                                            {/*begin::Timestamp=*/}
                                            <td className="pe-0 text-end min-w-200px">15 Apr 2021, 9:23 pm</td>
                                            {/*end::Timestamp=*/}
                                            </tr>
                                            {/*end::Table row*/}
                                            {/*begin::Table row*/}
                                            ...
                                            {/*end::Badge=*/}
                                            {/*begin::Status=*/}
                                            <td>POST /v1/invoices/in_6245_7416/payment</td>
                                            {/*end::Status=*/}
                                            {/*begin::Timestamp=*/}
                                            <td className="pe-0 text-end min-w-200px">19 Aug 2021, 10:10 pm</td>
                                            {/*end::Timestamp=*/}
                                            </tr>
                                            {/*end::Table row*/}
                                            {/*begin::Table row*/}
                                            ...
                                            {/*end::Status=*/}
                                            {/*begin::Timestamp=*/}
                                            <td className="pe-0 text-end min-w-200px">10 Nov 2021, 10:30 am</td>
                                            {/*end::Timestamp=*/}
                                            </tr>
                                            {/*end::Table row*/}
                                            {/*begin::Table row*/}
                                            ...
                                            {/*end::Badge=*/}
                                            {/*begin::Status=*/}
                                            <td>POST /v1/invoice/in_9921_8517/invalid</td>
                                            {/*end::Status=*/}
                                            {/*begin::Timestamp=*/}
                                            <td className="pe-0 text-end min-w-200px">05 May 2021, 6:43 am</td>
                                            {/*end::Timestamp=*/}
                                            </tr>
                                            {/*end::Table row*/}
                                            {/*begin::Table row*/}
                                ...
                                <div className="card pt-4 mb-6 mb-xl-9">
                                    ...
                                    <table className="table align-middle table-row-dashed fs-6 text-gray-600 fw-bold gy-5" id="kt_table_customers_events">
                                        ...
                                        <tr>
                                            ...
                                            {/*end::Event=*/}
                                            {/*begin::Timestamp=*/}
                                            <td className="pe-0 text-gray-600 text-end min-w-200px">22 Sep 2021, 5:30 pm</td>
                                            {/*end::Timestamp=*/}
                                        </tr>
                                        {/*end::Table row*/}
                                        {/*begin::Table row*/}
                                        <tr>
                                            ...
                                            {/*end::Event=*/}
                                            {/*begin::Timestamp=*/}
                                            <td className="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2021, 11:30 am</td>
                                            {/*end::Timestamp=*/}
                                        </tr>
                                        {/*end::Table row*/}
                                        {/*begin::Table row*/}
                                        ...
                                        <tr>
                                            ...
                                            {/*end::Event=*/}
                                            {/*begin::Timestamp=*/}
                                            <td className="pe-0 text-gray-600 text-end min-w-200px">20 Dec 2021, 10:30 am</td>
                                            {/*end::Timestamp=*/}
                                        </tr>
                                        {/*end::Table row*/}
                                        {/*begin::Table row*/}
                                        <tr>
                                            ...
                                            {/*end::Event=*/}
                                            {/*begin::Timestamp=*/}
                                            <td className="pe-0 text-gray-600 text-end min-w-200px">21 Feb 2021, 8:43 pm</td>
                                            {/*end::Timestamp=*/}
                                        </tr>
                                        {/*end::Table row*/}
                                        {/*begin::Table row*/}
                                        <tr>
                                            ...
                                            {/*end::Event=*/}
                                            {/*begin::Timestamp=*/}
                                            <td className="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2021, 10:10 pm</td>
                                            {/*end::Timestamp=*/}
                                        </tr>
                                        {/*end::Table row*/}
                                        {/*begin::Table row*/}
                                        ...
                                        <tr>
                                            ...
                                            {/*end::Event=*/}
                                            {/*begin::Timestamp=*/}
                                            <td className="pe-0 text-gray-600 text-end min-w-200px">24 Jun 2021, 6:43 am</td>
                                            {/*end::Timestamp=*/}
                                        </tr>
                                        {/*end::Table row*/}
                                        {/*begin::Table row*/}
                                        <tr>
                                            ...
                                            {/*end::Event=*/}
                                            {/*begin::Timestamp=*/}
                                            <td className="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2021, 10:30 am</td>
                                            {/*end::Timestamp=*/}
                                        </tr>
                                        {/*end::Table row*/}
                                        {/*begin::Table row*/}
                                        <tr>
                                            ...
                                            {/*end::Event=*/}
                                            {/*begin::Timestamp=*/}
                                            <td className="pe-0 text-gray-600 text-end min-w-200px">15 Apr 2021, 2:40 pm</td>
                                            {/*end::Timestamp=*/}
                                        </tr>
                                        {/*end::Table row*/}
                                        </tbody>
                    ...
                    <div className="modal fade" id="kt_modal_update_details" tabIndex={-1} aria-hidden="true">
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body py-10 px-lg-17">
                                ...
                                {/*begin::User toggle*/}
                                <div className="fw-boldest fs-3 rotate collapsible mb-7" data-bs-toggle="collapse" href="#kt_modal_update_user_user_info" role="button" aria-expanded="false" aria-controls="kt_modal_update_user_user_info">User Information
                                    <span className="ms-2 rotate-180">
                                    {/*begin::Svg Icon | path: icons/duotune/arrows/arr072.svg*/}
                                    <span className="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                                ...
                                <div id="kt_modal_update_user_user_info" className="collapse show">
                                    ...
                                    {/*end::Label*/}
                                    {/*begin::Input*/}
                                    <input type="text" className="form-control form-control-solid" placeholder name="name" defaultValue="Emma Smith" />
                                    {/*end::Input*/}
                                    </div>
                                    {/*end::Input group*/}
                                    {/*begin::Input group*/}
                                    ...
                                    {/*end::Label*/}
                                    {/*begin::Input*/}
                                    <input type="email" className="form-control form-control-solid" placeholder name="email" defaultValue="e.smith@kpmg.com.au" />
                                    {/*end::Input*/}
                                    </div>
                                    {/*end::Input group*/}
                                    {/*begin::Input group*/}
                                ...
                                <div className="fw-boldest fs-3 rotate collapsible mb-7" data-bs-toggle="collapse" href="#kt_modal_update_user_address" role="button" aria-expanded="false" aria-controls="kt_modal_update_user_address">Address Details
                                    <span className="ms-2 rotate-180">
                                    {/*begin::Svg Icon | path: icons/duotune/arrows/arr072.svg*/}
                                    <span className="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
                    ...
                    <div className="modal fade" id="kt_modal_add_schedule" tabIndex={-1} aria-hidden="true">
                        ...
                        <div className="modal-content">
                            ...
                            <form id="kt_modal_add_schedule_form" className="form" action="#">
                                ...
                                {/*end::Label*/}
                                {/*begin::Input*/}
                                <input type="text" className="form-control form-control-solid" name="event_name" defaultValue />
                                {/*end::Input*/}
                                </div>
                                {/*end::Input group*/}
                                {/*begin::Input group*/}
                                ...
                                <label className="fs-6 fw-bold form-label mb-2">
                                    ...
                                    <i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Select a date & time." />
                                </label>
                                {/*end::Label*/}
                                {/*begin::Input*/}
                                ...
                                {/*end::Label*/}
                                {/*begin::Input*/}
                                <input type="text" className="form-control form-control-solid" name="event_org" defaultValue />
                                {/*end::Input*/}
                                </div>
                                {/*end::Input group*/}
                                {/*begin::Input group*/}
                                ...
                                {/*end::Label*/}
                                {/*begin::Input*/}
                                <input id="kt_modal_add_schedule_tagify" type="text" className="form-control form-control-solid" name="event_invitees" defaultValue="e.smith@kpmg.com.au, melody@altbox.com" />
                                {/*end::Input*/}
                                </div>
                                {/*end::Input group*/}
                                {/*begin::Actions*/}
                    ...
                    <div className="modal fade" id="kt_modal_add_task" tabIndex={-1} aria-hidden="true">
                        ...
                        <div className="modal-content">
                            ...
                            <form id="kt_modal_add_task_form" className="form" action="#">
                                ...
                                {/*end::Label*/}
                                {/*begin::Input*/}
                                <input type="text" className="form-control form-control-solid" name="task_name" defaultValue />
                                {/*end::Input*/}
                                </div>
                                {/*end::Input group*/}
                                {/*begin::Input group*/}
                                ...
                                <label className="fs-6 fw-bold form-label mb-2">
                                    ...
                                    <i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Select a due date." />
                                </label>
                                {/*end::Label*/}
                                {/*begin::Input*/}
                                ...
                                {/*end::Label*/}
                                {/*begin::Input*/}
                                <textarea className="form-control form-control-solid rounded-3" defaultValue={""} />
                                {/*end::Input*/}
                                </div>
                                {/*end::Input group*/}
                                {/*begin::Actions*/}
                    ...
                    <div className="modal fade" id="kt_modal_update_email" tabIndex={-1} aria-hidden="true">
                        ...
                        <div className="modal-content">
                            ...
                            <form id="kt_modal_update_email_form" className="form" action="#">
                                ...
                                {/*end::Label*/}
                                {/*begin::Input*/}
                                <input className="form-control form-control-solid" placeholder name="profile_email" defaultValue="e.smith@kpmg.com.au" />
                                {/*end::Input*/}
                                </div>
                                {/*end::Input group*/}
                                {/*begin::Actions*/}
                        ...
                        <div className="modal-content">
                            ...
                            <form className="form" id="kt_modal_add_one_time_password_form">
                                ...
                                <label className="fs-6 fw-bold form-label mb-2">
                                    ...
                                    <i className="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="A valid mobile number is required to receive the one-time password to validate your account login." />
                                </label>
                                {/*end::Label*/}
                                {/*begin::Input*/}
                                <input type="text" className="form-control form-control-solid" name="otp_mobile_number" placeholder="+6123 456 789" defaultValue />
                                {/*end::Input*/}
                                </div>
                                {/*end::Input group*/}
                                {/*begin::Separator*/}
                                ...
                                {/*end::Label*/}
                                {/*begin::Input*/}
                                <input type="email" className="form-control form-control-solid" name="otp_email" defaultValue="e.smith@kpmg.com.au" readOnly="readonly" />
                                {/*end::Input*/}
                                </div>
                                {/*end::Input group*/}
                                {/*begin::Input group*/}
                                ...
                                {/*end::Label*/}
                                {/*begin::Input*/}
                                <input type="password" className="form-control form-control-solid" name="otp_confirm_password" defaultValue />
                                {/*end::Input*/}
                                </div>
                                {/*end::Input group*/}
                                {/*begin::Actions*/}
