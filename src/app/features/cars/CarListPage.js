...
const CarListPage = () => {
    ...
    return (
        <div id="kt_content_container" className="d-flex flex-column-fluid align-items-start container-xxl" >
            ...
            {showModal && <div>Add car Modal</div>
                // <div className="modal fade show" id="kt_modal_new_target" style={{ display: "block" }} tabIndex="-1">
                ...
                //                             <Link to={`/`} className="fw-bolder link-primary"> Submit Guidelines</Link>.</div>
                //                     </div>
