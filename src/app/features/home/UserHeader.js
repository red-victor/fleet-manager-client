            ...
            <div className="d-flex flex-wrap flex-sm-nowrap">
                <div className="me-7 mb-4">
                    <div className="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                        <img src={user.photoUrl ? user.photoUrl : ProfilePlaceholder} alt="Pic" style={{ objectFit: "cover" }} />
                        ...
                        <div className="d-flex flex-column flex-grow-1 pe-8">
                            <div className="d-flex flex-wrap">
                                <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div className="fw-bold fs-6 text-gray-400">Owed</div>
                                </div>
                                <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value={80}>0</div>
                                    </div>
