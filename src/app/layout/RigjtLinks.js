            ...
            <div class="topbar d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                        {/* begin::Heading */}
                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style={{backgroundImage: "url('../../assets/media/misc/pattern-1.jpg')"}}>
                            {/* begin::Title */}
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                                ...
                                <div class="py-3 text-center border-top">
                                    <a href="../../demo2/dist/pages/profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">View All </a>
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                        {/* begin::Heading */}
                        <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style={{backgroundImage: "url('../../assets/media/misc/pattern-1.jpg')"}}>
                            {/* begin::Title */}
                ...
                <div class="d-flex align-items-center me-n3 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    {/* begin::Menu wrapper */}
                    <div class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img class="h-30px w-30px rounded" src={ProfileImg} alt="" />
                    </div>
                    {/* begin::Menu */}
